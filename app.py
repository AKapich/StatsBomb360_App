...
st.sidebar.image("https://raw.githubusercontent.com/AKapich/Space_Control_App/main/EURO2024.png")
...
st.markdown('---')
st.image('https://raw.githubusercontent.com/AKapich/Space_Control_App/main/sb_icon.png',
